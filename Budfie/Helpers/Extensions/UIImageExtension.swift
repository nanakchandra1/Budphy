...
//=================================================================//
//MARK: UIImageView extension for getting the UIImage from the url
//=================================================================//

extension UIImageView {
    
    func setImage(withSDWeb urlString: String?, placeholderImage: UIImage) {
...
extension UIImage {
    ...
    func aspectFit(for boundingSize: CGSize) -> CGSize {
        ...
        let aspectRatio = CGSize(width: size.width, height: size.height)

        var mW = boundingSize.width / aspectRatio.width
        var mH = boundingSize.height / aspectRatio.height

        if( mH < mW ) {
            mW = boundingSize.height / aspectRatio.height * aspectRatio.width
        }
        else if( mW < mH ) {
            mH = boundingSize.width / aspectRatio.width * aspectRatio.height
        }
