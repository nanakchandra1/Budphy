//
//  ReceivedVoiceMessageCell.swift
//  Budfie
//
...
class ReceivedVoiceMessageCell: UITableViewCell {
    ...
    func populate(with message: ChatMessage, playedMessageId: String?, progress: Float, isPlaying: Bool, chatType: ChatType) {
