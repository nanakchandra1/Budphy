...
extension FTPopOverMenu {
    ...
    public static func showForSender(sender : UIView, with menuArray: [String], done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void) {
        self.sharedMenu.showForSender(sender: sender, or: nil, with: menuArray, menuImageArray: [], menuCountArray: [], done: done, cancel: cancel)
    }
    public static func showForSender(sender : UIView, with menuArray: [String], menuImageArray: [AnyObject], done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void) {
        self.sharedMenu.showForSender(sender: sender, or: nil, with: menuArray, menuImageArray: menuImageArray, menuCountArray: [], done: done, cancel: cancel)
    }
    public static func showForSender(sender : UIView, with menuArray: [String], menuCountArray: [Int], done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void) {
        self.sharedMenu.showForSender(sender: sender, or: nil, with: menuArray, menuImageArray: [], menuCountArray: menuCountArray, done: done, cancel: cancel)
    }
    
    public static func showForEvent(event : UIEvent, with menuArray: [String], done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void) {
        self.sharedMenu.showForSender(sender: event.allTouches?.first?.view!, or: nil, with: menuArray, menuImageArray: [], menuCountArray: [], done: done, cancel: cancel)
    }
    public static func showForEvent(event : UIEvent, with menuArray: [String], menuImageArray: [AnyObject], done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void) {
        self.sharedMenu.showForSender(sender: event.allTouches?.first?.view!, or: nil, with: menuArray, menuImageArray: menuImageArray, menuCountArray: [], done: done, cancel: cancel)
    }
    ...
    public static func showFromSenderFrame(senderFrame : CGRect, with menuArray: [String], done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void) {
        self.sharedMenu.showForSender(sender: nil, or: senderFrame, with: menuArray, menuImageArray: [], menuCountArray: [], done: done, cancel: cancel)
    }
    public static func showFromSenderFrame(senderFrame : CGRect, with menuArray: [String], menuImageArray: [AnyObject], done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void) {
        self.sharedMenu.showForSender(sender: nil, or: senderFrame, with: menuArray, menuImageArray: menuImageArray, menuCountArray: [], done: done, cancel: cancel)
    }
...
public class FTPopOverMenu : NSObject {
    ...
    fileprivate func showForSender(sender: UIView?, or senderFrame: CGRect?, with menuNameArray: [String]!, menuImageArray: [AnyObject]?, menuCountArray: [Int]?, done: @escaping (NSInteger) -> Void, cancel:@escaping () -> Void){
        ...
        self.menuCountArray = menuCountArray
    ...
    fileprivate func setupPopOverMenu() {
        ...
        popOverMenu.showWithAnglePoint(point: menuArrowPoint, frame: popMenuFrame, menuNameArray: menuNameArray, menuCountArray: menuCountArray, menuImageArray: menuImageArray, arrowDirection: arrowDirection, done: { (selectedIndex: NSInteger) in
...
extension FTPopOverMenu: UIGestureRecognizerDelegate {
    ...
    public func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        if ["UITableViewCellContentView", "UIStackView"].contains(touchClass) {
            return false
...
private class FTPopOverMenuView: UIControl {
    ...
    fileprivate var menuCountArray : [Int]!
    fileprivate var arrowDirection : FTPopOverMenuArrowDirection = .up
    ...
    fileprivate func showWithAnglePoint(point: CGPoint, frame: CGRect, menuNameArray: [String]!, menuCountArray: [Int]!, menuImageArray: [AnyObject]!, arrowDirection: FTPopOverMenuArrowDirection, done: @escaping ((NSInteger) -> Void)) {
...
extension FTPopOverMenuView : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if menuCountArray != nil {
            if (menuCountArray?.count)! >= indexPath.row + 1 {
                menuCount = (menuCountArray?[indexPath.row])!
            }
        }
        cell.setupCellWith(menuName: menuNameArray[indexPath.row], menuImage: imageObject, menuCount: menuCount)
