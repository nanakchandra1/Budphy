...
class SNVideoViewerViewController: UIViewController {
    ...
    func setupViews() {
        ...
        if #available(iOS 11.0, *) {
            agreeOption.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: 0).isActive = true
        } else {
        ...
        if #available(iOS 11.0, *) {
            discardOption.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: 0).isActive = true
        } else {
