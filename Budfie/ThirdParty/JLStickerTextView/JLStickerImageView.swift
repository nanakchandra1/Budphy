...
public class JLStickerImageView: FLAnimatedImageView, UIGestureRecognizerDelegate {
...
extension JLStickerImageView {
    ...
    @discardableResult
    public func addLabel() -> JLStickerLabelView {
...
extension JLStickerImageView {
    @objc func tapOutside(_ sender: UITapGestureRecognizer) {
        ...
        if let _: JLStickerLabelView = currentlyEditingLabel {
            ...
            if currentlyEditingLabel.frame.contains(location) {
